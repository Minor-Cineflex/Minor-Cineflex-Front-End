...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="bg-[#4C3A51] w-screen max-w-screen h-screen flex flex-col overflow-y-auto">
      ...
      <div className="pt-5 w-full flex mb-10 pl-16 gap-10 font-semibold text-[#E7AB79] underline text-lg">
        <button onClick={() => handleNavigate("/Movie")} className="hover:text-[#D4A373] hover:decoration-[#D4A373]">
          ภาพยนตร์
        </button>
        <button onClick={() => handleNavigate("/Cinema")} className="hover:text-[#D4A373] hover:decoration-[#D4A373]">
          โรงภาพยนตร์
        </button>
      </div>
